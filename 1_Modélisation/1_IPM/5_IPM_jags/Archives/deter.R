...
psi = matrix(NA, nrow = 15, ncol = 15)

phi = c(0.5,0.5)

kappa =c(1,1)

eta = matrix(NA, nrow = n.colony, ncol = n.colony)
nu = matrix(NA, nrow = n.colony, ncol = n.colony)
mean.eta = 0.2
mean.eta = 0.2
...
po = matrix(NA, nrow = 15, ncol = (n.years-1))
dp = array(NA, dim = c(ns,(n.years-1) ,ns))
dq = array(NA, dim = c(ns,(n.years-1) ,ns))
U = matrix(NA, nrow = ((n.years-1)*ns), ncol = (n.years*ns-(ns-1)))
pr = matrix(NA, nrow = ((n.years-1)*ns), ncol = (n.years*ns-(ns-1)))
